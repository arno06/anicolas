...
class GAQuery
{
	...
	/**
	 * Méthode de définition des métrics de la requ�te, attend en param&egrave;tre la liste des ces metrics
	 * @return GAQuery
	 */
	...
	/**
	 * Méthode de définition des metrics ou dimensions &agrave; prendre en compte dans le param&egrave;tre "sort" de la requ�te
	 * @return GAQuery
	 */
	...
	/**
	 * Force la requ�te &agrave; renvoyer des données au format JSON
	 * @return GAQuery
	 */
	...
	/**
	 * Force la requ�te &agrave; renvoyer des données au format XML
	 * @return GAQuery
	 */
	...
	/**
	 * Méthode d'éxecution de la requ�te Google Analytics en cours
	 * @throws Exception
	 * @return array
	 */
	...
	{
		if(!$this->context)
			throw new Exception("Impossible d'executer unen requ�te Analytics sans contexte GAnalyticsAPI");
