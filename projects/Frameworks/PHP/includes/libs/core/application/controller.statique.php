<?php
/**
 * Controller statique - définit les pages statiques "utilitaires"
 * 
 * 
...
//		        die("f");
	 ...
	 * ==> FORM[INPUTNAME] <== 
	 * 
	 * ATTENTION A LA TECHNIQUE DE RENVOIE D'INFORMATION !Méthode privée
	 *
	 * @return void
	 */
	public function upload_async()
	{
		...
		if(empty($response["error"]))
		{
			...
			{
				$response["error"] = "Champs ciblé n'est pas un input type 'file'";
				$this->response($response);
			}
