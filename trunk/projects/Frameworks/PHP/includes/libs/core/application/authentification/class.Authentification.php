...
{	
	...
	/**
	 * Méthode de vérification de l'identité de l'utilisateur (dans le cas o� on aura detecté une session correspondante)
	 * @return boolean
	 */
	...
	protected function parseSessionVar()
	{
		...
		{
			if(property_exists("Authentification",$name))
				$this->$name = $value;
		}
	}
