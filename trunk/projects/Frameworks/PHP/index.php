...
require_once("includes/libs/core/models/model.ModelAuthentification.php");
require_once("includes/libs/core/db/class.Query.php");
require_once("includes/libs/core/db/class.DBManager.php");
